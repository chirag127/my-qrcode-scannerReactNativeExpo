...
* **SCENARIO A: WEB / APP / EXTENSION (React Native)**
    * **Stack:** **TypeScript 6.x** (Strict), **React Native 0.74+**, **Expo SDK 51+**.
    * **State:** **Context API/Redux/MobX** (Choose based on complexity).
    * **UI:** **TailwindCSS v4** + **Nativewind**.
    * **Lint/Test:** **Biome** (Speed) + **Vitest** (Unit) + **Detox/E2E Playwright** (E2E).
